...
ElMatrix_tempsupport=cablemesh_temp.el_matrix[2]
...
tempsupport_section = fe.Section(**tempsupport_section_params, name='Tempsupport section')


# Section
sections_main = [cable_section]*ElMatrix.shape[0]
sections_tempsupport = [tempsupport_section]*ElMatrix_tempsupport.shape[0]

# Part
part_main = fe.Part(NodeMatrix, ElMatrix, sections_main,include_linear_kg=True)
part_tempsupporta = fe.Part(NodeMatrix, ElMatrix_tempsupport, sections_tempsupport,include_linear_kg=True)
...
# t_step1=10.0**np.array([-6,-4,-2,-1,0])
